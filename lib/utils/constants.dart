...
abstract class AppConstants {
  ...
  static const String SERVER_ERROR = 'Server error occurred. Please try again later.';
  static const String TIMEOUT_ERROR = 'Request timeout. Please try again.';
  static const String UNAUTHORIZED_ERROR = 'Session expired. Please login again.';
  ...
  static const String INSTAGRAM_PROFILE = 'https://www.instagram.com/yourprofile';
  static const String LINKEDIN_PROFILE = 'https://www.linkedin.com/company/yourcompany';
  ...
  static const String PASSWORD_REGEX = r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d@$!%*?&]{8,}$';
